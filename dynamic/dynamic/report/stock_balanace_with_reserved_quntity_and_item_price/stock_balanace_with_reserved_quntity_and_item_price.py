...
from dynamic.utils import get_reservation_qty
...
def execute(filters=None):
	...
	# 	'name': 'GP-88', 
	# 	'item_name': 'Oxo Acero ', 
	# 	'description': 'Oxo Acero Matt-Grey-60X60- Rectified ', 
	# 	'item_group': 'Glazed', 
	# 	'brand': 'Keros', 
	# 	'stock_uom': 'SQM', 
	# 	'opening_qty': 9.0, 
...
def get_item_price_and_total_reservation(data):
	for i in data:
		...
		if default_price_list:
			rate = frappe.db.get_value('Item Price', {'item_code': i['item_code'] , "price_list": default_price_list , "selling":1 }, "price_list_rate")
			i['item_price'] = rate  
		else:
			frappe.throw("Please Set a default price list in Selling Settings")
	return data
