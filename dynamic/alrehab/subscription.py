...
""" 
	This class ovrrides the main class to:
	1- handle assign date to current invoice start which after the subscription end date
	!!! curr_invoice_start > curr_invoice_end

	2- adding method for fetching all past invoices at once.
"""
...
class Subscription(Document):
	...
	def get_current_invoice_start(self, date=None):
		...
		elif date and date >= self.end_date:
			_current_invoice_start = self.current_invoice_start
		elif date:
